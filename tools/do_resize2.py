...
base = r'c:\Users\Yurec\OneDrive\НМК по дисциплінам\Практика з КСМ\НМК З КСМ практика\Новий формат лекцій\assets\lection2'
...
print(f"\nDone! Successfully resized {count} images in lection2.")
